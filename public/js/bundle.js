...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //Add markers

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Extend boundaries of the map to include locations

    bounds.extend(loc.coordinates); // Add popup
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Your ".concat(type.toUpperCase(), " was updated"));
              location.assign('me');
            }
...
var userPasswordForm = document.querySelector('.form-user-password'); //Delegate
...
if (userDataForm) userDataForm.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
